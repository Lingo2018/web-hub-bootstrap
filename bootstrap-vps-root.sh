...
echo ""
echo " NEXT: from your laptop run the operator one-liner:"
echo "   ./scripts/deploy-to-vps.sh root@$HOST_IP <domain>"
echo " It tar-uploads the source over ssh, runs phase 2, and verifies"
echo " health — no manual ssh from here on."
echo ""
echo " (Manual phase 2 is supported but discouraged: see bootstrap-vps-"
echo "  deploy.sh's WEB_HUB_REPO instructions if you really must run it"
echo "  by hand. The public mirror at Lingo2018/web-hub-bootstrap holds"
echo "  THIS script only — not the full app source — so a naive curl"
echo "  | bash of the deploy script will exit with a clear error asking"
echo "  for repo access.)"
echo "================================================================"
