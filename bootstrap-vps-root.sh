...
echo ""
echo " RECOMMENDED next step: from your laptop run the operator one-liner"
echo "   ./scripts/deploy-to-vps.sh root@$HOST_IP <domain>"
echo " which uploads source + runs phase 2 + verifies health, no manual ssh."
echo ""
echo " Or, manual phase 2 (will git-clone the public mirror):"
echo "   ssh $DEPLOY_USER@$HOST_IP"
echo "   DOMAIN=<your-domain> bash <(curl -fsSL https://raw.githubusercontent.com/Lingo2018/web-hub-bootstrap/main/bootstrap-vps-deploy.sh)"
echo "================================================================"
